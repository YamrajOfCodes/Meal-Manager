        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <button onClick={handleLogout} title="Logout" style={{
              ...
              <Ic d="M9 21H5a2 2 0 01-2-2V5a2 2 0 012-2h4M16 17l5-5-5-5M21 12H9" s={15} c="#dc2626" />
            </button>
          </div>
        </div>
      </header>
      ...
      <nav className="mob" style={{
        ...
        <div style={{
          ...
          <button
            ...
            <Ic d="M9 21H5a2 2 0 01-2-2V5a2 2 0 012-2h4M16 17l5-5-5-5M21 12H9" s={20} c="#dc2626" sw={1.7} />
            <span style={{
              fontSize: 9, fontWeight: 500,
              color: "#dc2626",
              letterSpacing: ".03em",
