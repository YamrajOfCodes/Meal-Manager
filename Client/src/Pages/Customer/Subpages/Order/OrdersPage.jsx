...
const getMeal = k => MEAL[k] || { label:k, bg:T.surface2, color:T.t2, icon:(c,s=18)=>(
          ...
          <div style={{margin:"-38px 22px 0",position:"relative",zIndex:10}}>
            <div className="bal-row" style={{display:"flex",alignItems:"center",gap:18,background:"white",borderRadius:16,border:`1px solid ${T.border}`,padding:"18px 22px",boxShadow:"0 6px 24px rgba(0,0,0,.10)"}}>
              ...
              <div className="bal-acts" style={{display:"flex",flexDirection:"column",gap:9,flexShrink:0}}>
                {balance>0&&<button className="paybtn"><Ic d="M12 2v20M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6" s={14} c="white" sw={2.2}/>Pay Now</button>}
                <button className="stmtbtn"><Ic d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1M16 8l-4-4-4 4M12 4v12" s={13} c={T.t2}/>Statement</button>
              </div>
            </div>
          </div>
